                                ...
                                <tbody>
                                    <tr>
                                        <td class="image product-thumbnail">
                                            <img src="{{ asset('assets/imgs/shop/product-1-2.jpg') }}"
                                                alt="#" />
                                        </td>
                                        <td class="product-des product-name">
                                            <h5 class="product-name">
                                                <a href="product-details.html">J.Crew Mercantile Women's
                                                    Short-Sleeve</a>
                                            </h5>
                                            <p class="font-xs">
                                    ...
                                    <tr>
                                        <td class="image">
                                            <img src="{{ asset('assets/imgs/shop/product') }}-11-2.jpg"
                                                alt="#" />
                                        </td>
                                        <td class="product-des">
                                            <h5 class="product-name">
                                                <a href="product-details.html">Amazon Essentials Women's
                                                    Tank</a>
                                            </h5>
                                            <p class="font-xs">
                                                Sit at ipsum amet clita no est,<br />
                                                sed amet sadipscing et gubergren
                                            </p>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="image">
                                            <img src="{{ asset('assets/imgs/shop/product-6-1.jpg') }}"
                                                alt="#" />
                                        </td>
                                        <td class="product-des">
                                            <h5 class="product-name">
                                                <a href="product-details.html">Amazon Brand - Daily Ritual
                                                    Women's Jersey
                                                </a>
                                            </h5>
                                            <p class="font-xs">
                                                Erat amet et et amet diam et et.<br />
                                                Justo amet at dolore
                                            </p>
                                        </td>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="cart_total_amount">
                                                        <span
                                                            class="font-lg fw-900 text-brand">$240.00</span>
                                                    </td>
                                                </tr>
                                                <tr>
